...
- [x] **6.5 Holdings + create + settings + analysis** — port `holdings.html` / `create-plan.html` + polish settings/analysis.

**Phase 6 COMPLETE (2026-06-05).**  the real app visually matches the mockups, fully wired to live data.
